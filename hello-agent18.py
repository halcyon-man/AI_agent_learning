...
def create_openai_model_client():
    ...
    return OpenAIChatCompletionClient(
        ...
        model_info ={
        "function_calling": True,  # 是否支持工具/函数调用（Agent必备！）
        "json_output": True,  # 是否支持输出JSON格式
        "vision": False,  # 是否支持图片视觉能力
        "family": "glm" , # 模型系列名称，随便填字符串
...
async def auto_input_func(prompt: str, token):
    # 自动返回，模拟人工测试完成，带上TERMINATE结束任务
    return "测试完成，代码逻辑和异常处理都没问题。TERMINATE"
